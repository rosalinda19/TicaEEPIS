<x-temp-layout>
    ...
    <div class="max-w-7xl mx-auto py-1 px-1">
        @if ($final)
            ...
            <a href="{{ route('mahasiswa.detail', 4) }}">
        ...
        @if ($tesis_2)
            ...
            <a href="{{ route('mahasiswa.detail', 3) }}">
                <div class="max-w-7xl mx-auto sm:px-6 lg:px-12">
                    <div class="bg-third rounded shadow-lg mb-6">
                        <div class="p-6 text-gray-900 dark:text-gray-100">
                            <div class="container">
        ...
        @if ($tesis_1)
            ...
            <a href="{{ route('mahasiswa.detail', 2) }}">
                <div class="max-w-7xl mx-auto sm:px-6 lg:px-12">
                    <div class="bg-third rounded shadow-lg mb-6">
                        <div class="p-6 text-gray-900 dark:text-gray-100">
                            <div class="container">
        ...
        @if ($proposal)
            ...
            <a href="{{ route('mahasiswa.detail', 1) }}">
                <div class="max-w-7xl mx-auto sm:px-6 lg:px-12">
                    <div class="bg-third rounded shadow-lg mb-6">
                        <div class="p-6 text-gray-900 dark:text-gray-100">
                            <div class="container">
        ...
        @if ($judul)
            ...
            <a href="{{ route('mahasiswa.detail', 5) }}">
                <div class="max-w-7xl mx-auto sm:px-6 lg:px-12">
                    <div class="bg-third rounded shadow-lg mb-6">
                        <div class="p-6 text-gray-900 dark:text-gray-100">
                            <div class="container">
                                ...
                                <div class="pl-6 pt-3 text-white font-medium">
                                    ...
                                    <div class="grid grid-cols-3 gap-2 mb-2">
                                        <span class="font-semibold col-span-1">1.
                                            {{ $judul->dosen_pembimbing1 }}</span>
                                    </div>
                                    <div class="grid grid-cols-3 gap-2 mb-2">
                                        <span class="font-semibold col-span-1">2.
                                            {{ $judul->dosen_pembimbing2 }}</span>
                                    </div>
                                    <div class="grid grid-cols-3 gap-2 mb-2">
                                        <span class="font-semibold col-span-1">3.
                                            {{ $judul->dosen_pembimbing3 }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
